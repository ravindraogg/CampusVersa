          ...
          <div className="bg-white rounded-3xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col">
            ...
            <div className="p-6 border-b border-gray-100 flex justify-between items-center sticky top-0 bg-white z-10">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                <Edit className="w-5 h-5 text-blue-600" /> Edit Contact Info
              </h3>
              <button
        ...
        <div className="relative flex flex-col md:flex-row gap-8 items-start">
          <div className="flex flex-col items-center space-y-4">
            ...
            >
              ...
              {/* Status Badge */}
              <div
                className={`absolute bottom-1 right-1 w-8 h-8 rounded-full border-4 border-white flex items-center justify-center shadow-sm z-20 bg-green-500`}
              >
          ...
          <div className="flex-1 pt-2">
            <div className="mb-6 text-center md:text-left">
              ...
              <p className="text-lg text-gray-500 font-medium flex items-center justify-center md:justify-start gap-2">
                ...
                <span>{student.department} Dept.</span>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <InfoItem 
                icon={MapPin} 
                label="Institute" 
                value={institute?.name || "CampusVersa"} // Fetched dynamically
              />
            </div>
          </div>
        </div>
